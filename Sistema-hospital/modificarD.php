...
<body>
  ...
  <nav>
    ...
    <center>
    <div class="wrapper">
      <h2>Modificación de doctores</h2>
      <form method="POST" action="modificarDoctores.php">
        <div class="input-box">
      ...
      <select class="opciones" name="zona">
                      <?php
                      include 'conexion.php';
                      $query=mysqli_query($conexion,"SELECT * FROM zonas");
                        while($datos=mysqli_fetch_array($query))
                        {
                      ?>
                          <option value="<?php echo $datos['zona_id']?>">
