        ...
        <div class="nav-bar"> 
          ...
          <i class='bx bx-menu' ></i>
            ...
            <div class="menu">
                ...
                <ul class="nav-links">
                    <li><a href="altaE.php">Agregar</a></li>
                    <li><a href="#">Modificar</a></li>
                    <li><a href="bajaE.php">Eliminar</a></li>
                </ul>
            </div>
                ...
                <div class="searchBox">
                   <div class="searchToggle">
                    ...
                    <div class="search-field">
                        <input type="text" placeholder="busca un enfermero">
...
$sql = "SELECT enfermeros.nombre en, enfermeros.apellido ea, enfermeros.dni e_dni, enfermeros.fecha_ingreso fi, zonas.descripcion zd FROM enfermeros LEFT JOIN zonas ON enfermeros.zona_id=zonas.zona_id";
