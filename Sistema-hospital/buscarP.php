...
<body>
  ...
  <nav>
          ...
          <i class='bx bx-menu' ></i>
            ...
            <div class="menu">
                ...
                <ul class="nav-links">
                    ...
                    <li><a href="altaPaciente.php">Agregar</a></li>
    ...
    <div class="wrapper">
      ...
      <form method="GET" action="buscarPaciente.php">
        <div class="input-box">
          <input type="int" name="dni_paciente" placeholder="ingrese el DNI del paciente" required>
        </div>
