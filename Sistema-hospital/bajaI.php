...
<body>
  ...
  <nav>
        <div class="nav-bar"> 
          ...
          <i class='bx bx-menu' ></i>
            ...
            <div class="menu">
                ...
                <ul class="nav-links">
                    <li><a href="turnos.php">Internaciones</a></li>
    ...
    <div class="wrapper">
      <h2>Baja de Internaciones</h2>
      <form method="POST" action="bajaInternaciones.php">
        <div class="input-box">
          <input type="int" name="dni" placeholder="ingrese el DNI del paciente" required>
        </div>
