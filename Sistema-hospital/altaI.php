...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="css/altaD.css">
...
<body>
  ...
  <section class="home-section">
        ...
        <div class="nav-bar"> 
          ...
          <i class='bx bx-menu' ></i>
            ...
            <div class="menu">
                ...
                <ul class="nav-links">
                    <li><a href="internaciones.php">Internaciones</a></li>
                    <li><a href="#">Modificar</a></li>
                    <li><a href="bajaI.php">Eliminar</a></li>
                </ul>
            </div>
    ...
    <center>
    <div class="wrapper">
      <h2>Carga de internaciones</h2>
      <form method="post" action="altaInternaciones.php">
      <div class="input-box">
          <label>Doctor</label>
      <select class="opciones" name="doctor">
                      <?php
                      include 'conexion.php';
                      $query=mysqli_query($conexion,"SELECT * FROM doctores");
                        while($datos=mysqli_fetch_array($query))
                        {
                      ?>
                          <option value="<?php echo $datos['doctor_id']?>">
                          <?php echo $datos['nombre']?> <?php echo $datos['apellido']?></option>
                    <?php
                        }
                    ?>
      ...
      <select class="opciones" name="paciente">
      <?php
                  ...
                  while ($valores = mysqli_fetch_array($query)) {
                    ...
                    echo '<option value="'.$valores['paciente_id'].'">'.$valores['nombre'].' '.$valores['apellido'].'</option>';
        ...
        <div class="input-box">
          ...
          <input type="date" name="fecha" placeholder="ingrese la fecha de ingreso" required>
      </div><br>
