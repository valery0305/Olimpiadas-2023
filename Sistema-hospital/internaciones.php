        ...
        <div class="nav-bar"> 
          ...
          <i class='bx bx-menu' ></i>
            ...
            <div class="menu">
                ...
                <ul class="nav-links">
                    <li><a href="altaI.php">Agregar</a></li>
                ...
                <div class="searchBox">
                   <div class="searchToggle">
                    ...
                    <div class="search-field">
                        <input type="text" placeholder="busca a un paciente internado">
...
$sql = "SELECT internaciones.fecha_internacion fecha, doctores.nombre dn, doctores.apellido da,pacientes.nombre pn, pacientes.apellido pa, pacientes.dni p_dni
FROM internaciones
 LEFT JOIN doctores ON internaciones.doctor_id=doctores.doctor_id 
