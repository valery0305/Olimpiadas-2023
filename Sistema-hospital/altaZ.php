...
<body>
  ...
  <nav>
    ...
    <center>
    <div class="wrapper">
      <h2>Carga de zonas</h2>
      <form method="POST" action="altaZonas.php">
      <div class="input-box">
          <input type="text" name="descripcion" placeholder="ingrese el nombre de la zona" required>
        </div>
        <div class="input-box">
          <input type="number" name="num" placeholder="ingrese el N° de zona" required>
        </div>
